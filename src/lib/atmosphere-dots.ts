 ...
 *
 * 数量演变：初版 46 → 60 → 300 → 500 → 900 → 1500 → §17 回调 1200。
 * 1200 个 LCG 纯随机点在宽版（内容列可达 ~1680px、项目增多后高度可达 3000px+）
 * 下仍保持均匀细腻；页面随项目增加而拉长，密度自然被摊薄，故保持较大基数。
 * 卡片为半透明底色，卡片内的点比卡片外浅（§9 / §11 / §13）。
 */
